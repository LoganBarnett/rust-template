...
async fn test_openapi_endpoint() {
    ...
    assert!(body_str.contains("openapi"), "OpenAPI spec should contain 'openapi' field");
    assert!(body_str.contains("/healthz"), "OpenAPI spec should document /healthz endpoint");
    assert!(body_str.contains("/metrics"), "OpenAPI spec should document /metrics endpoint");
}
