...
Break long lines by splitting argument lists and other repetitious items.
...
Breaking the argument list makes it fit within 80 columns.
...
Argument lists, struct fields, match arms, and similar multi-line constructs
should have a trailing comma on the last item.
